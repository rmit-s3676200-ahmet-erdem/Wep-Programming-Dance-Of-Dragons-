        ...
        <fieldset><legend>Booking Form:</legend>
          <div class="row">
            <div class="five columns">
                ...
                <select onclick='mvFunc()' class="dropdown u-full-width" form="tickets" name="booking[movie]" id="movieTitle" required>
            ...
            <div class="five columns">
              <label>Select Session:</label>
                <select onchange='sessionFunction()'class="dropdown u-full-width" form="tickets" name="booking[session]" id="session" required>
                  <option selected disabled >Please select movie</option>
                </select>
            </div>
          </div>
